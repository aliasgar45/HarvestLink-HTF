    ...
    <div>
      <div className="home-page-top-div">
        <div className="home-page-inner-top-div">
          <img
            src={pic}
            style={{ width: "6.5rem", marginLeft: "-1rem", marginTop: "-0.5rem" }}
            alt=""
          />
        </div>
        <div>
        ...
        <>
            ...
            <div className="home-page-food-d-outer-div">
              <div className="home-page-food-donation-card-div">
                <div className="home-page-food-donation-card-left-div">
                  <img style={{ width: "5.5rem", borderRadius: "0.5rem" }} src={img} alt="" />
                </div>
                <div className="home-page-food-donation-card-right-div">
                  <div style={{ display: "flex", alignItems: "flex-start", flexDirection: "column", gap: "0.8rem" }}>
                    <label style={{ fontSize: "1rem" }}>{foodDonation?.orgName}</label>
                    <div style={{ display: "flex", alignItems: "flex-start", flexDirection: "row" }}>
                      <LocationOnIcon style={{ color: "#b8b8b8", width: "1.5rem" }} />
                      <label style={{ fontSize: "0.8rem", color: "#B8b8b8" }}>{foodDonation?.address}</label>
                    </div>
                    <div style={{ display: "flex", alignItems: "flex-start", flexDirection: "row" }}>
                      <TakeoutDiningIcon style={{ color: "#b8b8b8", width: "1.5rem" }} />
                      <label style={{ fontSize: "0.8rem", color: "#B8b8b8" }}>Available Meal for {foodDonation?.foodQuantity}</label>
                    </div>
                  </div>
                  <div className="home-page-food-donation-card-button-div">
                    <button className="home-page-accept-button">Accept Request</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="home-page-category-div">
            ...
            <div className="home-page-category-cards-div">
              ...
              <Link to={"/volunteer"} style={{ textDecoration: "none", color: "#000" }}>
                <div className="home-page-category-card">
          ...
          <div className="home-page-food-r-request-div">
            ...
            <div className="home-page-food-d-outer-div">
              <div className="home-page-food-donation-card-div">
                ...
                <div className="home-page-food-donation-card-right-div">
                  <div style={{ display: "flex", alignItems: "flex-start", flexDirection: "column", gap: "0.8rem" }}>
                    <label style={{ fontSize: "1rem" }}>{foodRequest?.orgName}</label>
                    <div style={{ display: "flex", alignItems: "flex-start", flexDirection: "row" }}>
                      <LocationOnIcon style={{ color: "#b8b8b8", width: "1.5rem" }} />
                      <label style={{ fontSize: "0.8rem", color: "#B8b8b8" }}>{foodRequest?.address}</label>
                    </div>
                    <div style={{ display: "flex", alignItems: "flex-start", flexDirection: "row" }}>
                      <TakeoutDiningIcon style={{ color: "#b8b8b8", width: "1.5rem" }} />
                      <label style={{ fontSize: "0.8rem", color: "#B8b8b8" }}>Need Meal for {foodRequest?.foodQuantity}</label>
                    </div>
                  </div>
                  <div className="home-page-food-donation-card-button-div">
                    <button className="home-page-accept-button">Accept Request</button>
